...
# створює Helm-реліз Jenkins у кластері EKS
resource "helm_release" "jenkins" {
  name             = "jenkins"                      # назва релізу, яка з'явиться у кластері
  namespace        = var.namespace                  # namespace, куди буде встановлено Jenkins
  repository       = "https://charts.jenkins.io"    # офіційний репозиторій Helm-чартів Jenkins
  chart            = "jenkins"
  version          = "5.8.68"
